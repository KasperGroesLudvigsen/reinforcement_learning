...
class QNet(nn.Module):
    ...
    def __init__(self, lr, input_dims, num_actions, name, checkpoint_dir = "tmp/sac",
        ...
        self.fc1 = nn.Linear(self.input_dims[0] + num_actions, self.fc1_dims)
        self.fc2 = nn.Linear(self.fc1_dims, self.fc2_dims)
        self.q = nn.Linear(self.fc2_dims, 1)
    

    def activation_func(self, input, func):
        """
        ...
        The torch libary is imported as T, so use "T.relu" for example.
    ...
    def forward(self, state, action):
        ...
        action_value = self.activation_func(action_value)
